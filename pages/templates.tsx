  ...
  return (
    <Layout>
      <div className="space-y-4 mb-6">
        ...
        <p className="text-sm text-slate-600">Pick a template, tweak a few words, and publish.</p>
      </div>
      <div className="grid md:grid-cols-3 gap-4">
        {templates.map(tpl => (
          <div key={tpl.id} className="vl-card p-4 flex flex-col justify-between">
            ...
            <div className="mt-4">
              <Link href={{ pathname:"/create", query:{ theme: tpl.theme, tone: tpl.tone, idea: tpl.idea } }} className="vl-btn vl-btn-primary w-full">
                Use this template
              </Link>
            </div>
          </div>
